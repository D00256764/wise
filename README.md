...
Title: MoneyWise - An Interactive Financial Literacy Platform for Irish Young Adults
...
Budget Calculator (BudgetCalculator.test.jsx): Verified that income and expense inputs correctly calculate totals.
